...
PLATFORMS: dict[str, dict[str, str]] = {
    ...
    "fd": {
        "label": "FanDuel",
        "avg_fs_field": "avg_fantasy_score_fd",
        "trend_field": "trend_score_fd",
        "trend_dir_field": "trend_direction_fd",
        "streak_field": "hot_streak_fd",
        "surging_field": "is_surging_fd",
        "surge_pct_field": "surge_delta_pct_fd",
